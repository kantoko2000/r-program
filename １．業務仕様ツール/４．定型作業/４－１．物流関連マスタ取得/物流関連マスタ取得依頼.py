...
####メイン処理####
# リストを作成
syori_taisyo = ["顧客納品リードタイム決定マスタ_マシン配送・サプライ在庫区","顧客納品リードタイム決定マスタ_マシン配送・マシン在庫区","物流拠点間リードタイム決定マスタ","地区マスタ","顧客納品リードタイム決定マスタ_マシン配送以外全て","手配締時刻マスタ","在庫区決定マスタ","配送パターン決定マスタ","顧客納品リードタイム決定マスタ_混載配送(物流拠点130006、270019)","顧客納品リードタイム決定マスタ_混載配送(物流拠点130006、270019、010001、040001、230001、340001、410001、460001、160001)","搬入出付帯作業実施可否マスタ"]
#syori_taisyo = ["地区マスタ"]
